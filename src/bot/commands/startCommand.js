...
module.exports = async (bot, msg) => {
    ...
    try {
        if (telegramId === adminTelegramId) {
            await safeSendGroupMessage(bot, chatId, "Hello, you are the admin.");
            return;
        }
        ...
        if (!user) {
            ...
            await safeSendGroupMessage(bot, chatId, "Hello, you are not subscribed to the forex trading group.");
